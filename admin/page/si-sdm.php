            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="page" value='../index.php?page=si-sdm'>
...
<h2 style="margin-bottom: 20px; text-align:center;"><b>Artikel Sistem Informasi SDM</b></h2>
...
<?php 
    $no = 1;
    $query = "SELECT * FROM artikel_bacaan WHERE id_judul = 5";
